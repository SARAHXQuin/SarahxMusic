...
from sarahxmusic.utils import first_page, second_page
from sarahxmusic.utils.database import get_lang
from sarahxmusic.utils.decorators.language import LanguageStart, languageCB
from sarahxmusic.utils.inline.help import help_back_markup, private_help_panel
...
@app.on_callback_query(filters.regex("sarahx1") & ~BANNED_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("sarahx2") & ~BANNED_USERS)
@languageCB
